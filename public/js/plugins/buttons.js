...
!(function () {
    ...
    var o = window.document,
            ...
            return function (e, t, r) {
                ...
                if (null != t)
                    for (var n in t) {
                        var i = t[n];
                        null != i &&
                            (null != a[n] ? (a[n] = i) : a.setAttribute(n, i));
                    }
                return (
                    null != r &&
                        u(r, function (e) {
                            a.appendChild(
                                "string" == typeof e ? o.createTextNode(e) : e
                            );
                        }),
                    a
                );
            ...
            return (
                u(o.split(e), function (o) {
                    if ("" !== o) {
                        var e = o.split(t);
                        a[r(e[0])] =
                            null != e[1] ? r(e.slice(1).join(t)) : void 0;
                    }
                }),
                a
            );
        ...
        E = function (o) {
            return (
                (_ > 1 ? t.ceil((t.round(o * _) / _) * 2) / 2 : t.ceil(o)) || 0
            );
        },
        G = function (o, e) {
                ...
                if (
                    ...
                    var c = function () {
                        ...
                        try {
                            ...
                            return void o.body.appendChild(
