<x-app-layout>
    ...
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0">Buy and Sell Add</h6>
    </nav>
    @endsection
    @section('content')
                ...
                <div class="card mb-4">
                    <div class="card-body px-3 pt-3 pb-3">
                        <div class="card card-plain">
                            <div class="card-body">
                                <form role="form" id="addbuysell" name="addbuysell" method="POST" action="{{ route('buysell.store') }}">
                                    @csrf
                            ...
                            <div class="text-center">
                                <a href="{{route('buysell.index')}}" class="btn btn-sm btn-secondary w-15 mb-0">Cancel</a>
