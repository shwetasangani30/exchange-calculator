<x-app-layout>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Sell and Buy</li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Sell and Buy</h6>
    </nav>
    @endsection
    @section('content')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-sm">
                                                ...
                                                <a href="{{route('sellbuy.show',$buy_sell->buy_sell_id)}}" class="btn btn-info btn-xs" data-original-title="Info"><i class="fa fa-info-circle"></i> Info</a>
                                                <br>
                                                <button type="button" data-buy-sell-id="{{$buy_sell->buy_sell_id}}" class="sellbtn btn btn-success btn-xs" data-original-title="Sell"> <i class="fa fa-share"></i> Buy</button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
    ...
    <div id="closeModal" class="modal fade" role="dialog" aria-labelledby="closeModalLabel">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <form action="{{ route('sellbuy.buyClose') }}" method="POST" id="closeModelFrm">
                    @csrf
    ...
    <div id="sellModal" class="modal fade" role="dialog" aria-labelledby="sellModalLabel">
        <div class="modal-dialog">
            ...
            <!-- Modal content-->
            <div class="modal-content">
                <form action="{{ route('sellbuy.buy') }}" method="POST" id="sellModelFrm">
                    @csrf
                    <input type="hidden" value="" name="buy_sell_id" id="buy_sell_id">
                    <div class="modal-header">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("div.toolbar").html('<a href="{{ route("sellExport")}}" style="float:right;"  class="btn btn-info btn-xs mx-2" data-toggle="tooltip" data-original-title="Export to Exce"><i class="fa fa-file-excel-o"></i> Export to Excel</a> <a href="{{ route("sellbuy.create")}}" style="float:right;"  class="btn btn-primary btn-xs mx-2" data-toggle="tooltip" data-original-title="Add"><i class="fa fa-plus"></i> Add</a>');
