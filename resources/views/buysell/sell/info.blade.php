<x-app-layout>
    ...
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0">Sell & Buy Info</h6>
    </nav>
    @endsection
    @section('content')
                            ...
                            <table id="buysell" class="table align-items-center mb-0 display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm">
                                            <form action="{{ route('sellbuy.destroy',$buysell->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <a href="{{ route('sellbuy.edit',$buysell->id) }}" class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i> Edit
                                                </a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("div.toolbar").html('<a href="{{route("sellbuy.index")}}" style="float:right;"  class="btn btn-secondary btn-xs mx-2" data-toggle="tooltip" data-original-title="Back"><i class="fa fa-arrow-left"></i> Back</a>');
